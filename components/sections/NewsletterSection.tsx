        ...
        <div className="flex flex-col items-center text-center">
          ...
          >
            ...
            <button
              ...
              className="group relative flex items-center gap-2 overflow-hidden rounded-full bg-[#262626] px-8 py-4 text-[16px] font-medium text-white transition-all hover:bg-[#404040] disabled:cursor-not-allowed disabled:opacity-50 max-[640px]:w-full max-[640px]:justify-center"
            >
